...
export class Query {
  ...
  allUser: (args: { resourceId: t.String }) => User[];
  userMe: User;
  resource: (args: { id: t.String }) => Resource;
  shopifyAllProductId: (args: { resourceId: t.String }) => t.String[];
  socialProfile: (args?: { profileId?: t.String }) => Profile;
  allSocialProfile: Profile[];
  socialPost: (args: { postId: t.String }) => t.Nullable<Post>;
  allSocialPost: (args?: { filters?: FiltersInputInput }) => Post[];
  allSocialPostTrending: (args?: { filters?: FiltersInput_1Input }) => Post[];
  version: t.String;
  constructor() {
    this.__typename = "";
    this.user = fnProxy(User);
    this.allUser = fnArrayProxy(User);
    this.userMe = proxy(User);
    this.resource = fnProxy(Resource);
    this.shopifyAllProductId = () => [];
    this.socialProfile = fnProxy(Profile);
    this.allSocialProfile = arrayProxy(Profile);
    this.socialPost = fnProxy(Post);
    this.allSocialPost = fnArrayProxy(Post);
    this.allSocialPostTrending = fnArrayProxy(Post);
    this.version = "";
  }
}
export class User {
  ...
  constructor() {
    ...
    this.emails = arrayProxy(UserEmail);
  }
}
...
export class Resource {
  ...
  secret: (args: { name: t.String }) => Secret;
  constructor() {
    this.__typename = "";
    this.id = "";
    this.name = "";
    this.config = null;
    this.secret = fnProxy(Secret);
  }
}
export class Secret {
  __typename: t.String;
...
export class Profile {
  ...
  constructor() {
    ...
    this.createdAt = "";
    this.updatedAt = "";
    this.posts = arrayProxy(Post);
    this.starredPosts = arrayProxy(StarredPosts);
    this.followers = arrayProxy(Profile);
    this.following = arrayProxy(Profile);
    this.activity = arrayProxy(Activity);
    this.views = null;
  }
}
export class Post {
...
export class Mutation {
  ...
  userSignOut: (args?: { resourceId?: t.String }) => t.NotSupportedYet;
  userRefresh: (args: {
    accessToken: t.String;
    refreshToken: t.String;
  }) => UserRefresh;
  userSSO: (args: { resourceId: t.String }) => UserSSO;
  userRegister: (args: {
    resourceId: t.String;
    values: ValuesInputInput;
    skipEmailVerification?: t.Boolean;
  }) => UserRegister;
  userUpdate: (args: { id: t.String; values: ValuesInput_1Input }) => User;
  ...
  userEmailConfirmationResend: (args: { emailId: t.String }) => Email;
  userEmailUpdate: (args: {
    emailId: t.String;
    values: ValuesInput_1_2Input;
  }) => UserEmail;
  userEmailDelete: (args: { emailId: t.String }) => t.Boolean;
  ...
  socialProfileUpdate: (args: { data: ProfileInput }) => Profile;
  socialProfileDelete: t.Boolean;
  socialProfileFollow: (args: { followProfileId: t.String }) => ProfileFollow;
  socialProfileUnfollow: (args: { followProfileId: t.String }) => ProfileFollow;
  socialPostCreate: (args: { values: PostDataInputInput }) => Post;
  socialPostUpdate: (args: {
    postId: t.String;
    values: PostUpdateDataInputInput;
  }) => Post;
  socialPostDelete: (args: { postId: t.String }) => t.NotSupportedYet;
  socialPostStar: (args: { postId: t.String }) => PostStar;
  socialPostUnstar: (args: { postId: t.String }) => PostStar;
  constructor() {
    this.__typename = "";
    this.passwordReset = () => false;
    this.passwordResetConfirm = () => false;
    this.userSignIn = fnProxy(UserSignIn);
    this.userSignOut = () => null;
    this.userRefresh = fnProxy(UserRefresh);
    this.userSSO = fnProxy(UserSSO);
    this.userRegister = fnProxy(UserRegister);
    this.userUpdate = fnProxy(User);
    this.userDelete = () => false;
    this.userEmailCreate = fnProxy(UserEmail);
    this.userEmailConfirm = fnProxy(UserEmailConfirm);
    this.userEmailConfirmationResend = fnProxy(Email);
    this.userEmailUpdate = fnProxy(UserEmail);
    this.userEmailDelete = () => false;
    this.userExternalCredentialCreate = () => "";
    this.jaenPublish = () => "";
    this.shopifyProductCreate = () => "";
    this.shopifyProductUpdate = () => "";
    this.shopifyProductDelete = () => "";
    this.mailpressMailSchedule = () => "";
    this.socialProfileCreate = proxy(Profile);
    this.socialProfileUpdate = fnProxy(Profile);
    this.socialProfileDelete = false;
    this.socialProfileFollow = fnProxy(ProfileFollow);
    this.socialProfileUnfollow = fnProxy(ProfileFollow);
    this.socialPostCreate = fnProxy(Post);
    this.socialPostUpdate = fnProxy(Post);
    this.socialPostDelete = () => null;
    this.socialPostStar = fnProxy(PostStar);
    this.socialPostUnstar = fnProxy(PostStar);
  }
}
export class UserSignIn {
  ...
  constructor() {
    this.__typename = "";
    this.tokenPair = proxy(TokenPair);
...
export class Email {
  ...
  constructor() {
    ...
    this.isVerified = false;
    this.userId = null;
    this.config = proxy(EmailConfig_1);
  }
}
export class EmailConfig_1 {
  ...
  constructor() {
    ...
    this.id = "";
    this.isEnabled = false;
    this.externalCredential = proxy(ExternalCredential_1);
  }
}
